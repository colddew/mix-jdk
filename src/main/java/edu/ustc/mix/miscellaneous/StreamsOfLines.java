...
public class StreamsOfLines {
	...
	public static void main(String[] args) throws IOException {
		...
		Path path = Paths.get("/Users/workspace-mars/mix-jdk/src/main/java/edu/ustc/mix/miscellaneous/StreamsOfLines.java");
		
		// lines方法延迟读取一个文件中的行, 使用try-with-resources确保资源关闭
		...
		try (Stream<String> filteredLines = Files.lines(path).onClose(() -> System.out.println("Closing"))
